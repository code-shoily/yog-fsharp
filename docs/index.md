...
[![Build Status](https://github.com/code-shoily/yog-fsharp/workflows/CI/badge.svg)](https://github.com/code-shoily/yog-fsharp/actions)
...
- **[Getting Started](tutorials/getting-started.html)** - Installation and basic usage
- **[Examples](examples.html)** - Real-world examples and use cases
- **[Tutorials](tutorials.html)** - In-depth guides
...
- **Pathfinding Algorithms**: Dijkstra, A*, Bellman-Ford, Floyd-Warshall, and **Implicit Variants**
...
- **Graph Centrality**: Degree, betweenness, closeness, harmonic, and alpha centrality
...
This is an F# port of the [Gleam Yog](https://github.com/code-shoily/yog) library. While not a 1:1 port, it captures the spirit and functional API of the original.
